...
async function computeBalanceSheet(clientId: string, periodEnd: string, lines: any[], customPLGroups: Record<string, PLGroup> = {}, jobId?: string | null) {
